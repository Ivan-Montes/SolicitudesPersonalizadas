...
<html lang="es">
    <head>
        ...
        <title>Gestión Personalizadas</title>
    </head>
    <body>

        <?php
        $vPass = "783626575869232435243657687690";
        ...
        if ($vClaveEscrita != $vPass) {
    ?>
         <form name="fLogin" method="post" action="" class="w3-row form__login--01">
            <div class="w3-content">
                <div  class="w3-row">
                    <div class="w3-col m6 l3 w3-display-middle">
                        <div class="w3-card-2 w3-padding-large w3-topbar w3-bottombar w3-border-teal login__box">
                            <h2 class="w3-center">Login</h2>
                            <input class="w3-input w3-hover-grey"type="password" name="InPassGestion" placeholder="Escribe la contraseña"><br>
                            <input class="w3-input w3-teal w3-hover-grey" type="submit" value="Entrar" class="w3-margin-top">
                        </div>
                    </div>
                </div>
            <div>
        ...
        <header class="header--abs">
            <nav>
                <div class="w3-sidebar w3-bar-block w3-animate-left" style="display:none;z-index:5" id="mySidebar">
                    ...
                    <div id="bSincroBd" class="w3-button w3-blue w3-hover-red w3-margin w3-ripple w3-round w3-tiny">Syn shop</div>
                    <div id="bSincroColegios" class="w3-button w3-blue w3-hover-red w3-margin w3-ripple w3-round w3-tiny">Syn Sp</div>
                </div>
                ...
                <div class="my-burguer__dad--separations">
                    <button class="w3-button w3-xlarge my-burguer--01 js-my-burguer01--open" style="z-index:4" >&#9776;</button>
                </div>
            </nav>
        </header>
        <div class="w3-content my-padding__top--soli">
            <div class="w3-card-4">
                <div class="w3-container w3-teal w3-center w3-topbar w3-bottombar w3-border-amber">
                    <h2>Gestión Personalizadas</h2>
                 </div>
                ...
                <div class="w3-container">
                        <div class="w3-row-padding">
                            ...
                            <div class="w3-center">
                                <div class="w3-bar">
                                    <div id="inSubmitFormGestion" class="w3-button w3-teal w3-hover-lime w3-margin w3-ripple">Buscar</div>
                ...
                <div class="w3-responsive">
                    <table class="w3-table-all w3-hoverable w3-centered js-ta--query" id="taFormGestion">
                            <tr class="w3-teal">
                                <th>ID</th>
                                <th>Sucursal</th>
                                <th>Spain</th>
